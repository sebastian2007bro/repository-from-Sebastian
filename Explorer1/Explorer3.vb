...
Public Class Explorer3
    ...
    Private Sub Explorer3_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'Set up the UI
    ...
    Private Sub LoadTree()
        ...
        tvRoot = Me.TreeView.Nodes.Add("Program")
        tvNode = tvRoot.Nodes.Add("Sebs SW CV")

        tvRoot = Me.TreeView.Nodes.Add("Program")
        tvNode = tvRoot.Nodes.Add("Sebs SW")
        tvNode = tvRoot.Nodes.Add("Sebs SW CV")
        tvNode = tvRoot.Nodes.Add("Sebs SW PV")
    End Sub
    ...
    Private Sub LoadListView()
        ...
        lvItem = ListView.Items.Add("Sebs SW")
    ...
    Private Sub SetUpListViewColumns()
        ...
        lvColumnHeader = ListView.Columns.Add("Sebs SW CV")
        ...
        lvColumnHeader = ListView.Columns.Add("Sebs SW")
        lvColumnHeader.Width = 70

        lvColumnHeader = ListView.Columns.Add("Sebs SW PV")
        lvColumnHeader.Width = 70
